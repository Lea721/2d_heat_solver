...
def plot_heatmap(data, step, output_dir="plots_parallel_nonblocking"):  # ← KEEP THIS
...
if __name__ == "__main__":
    ...
    try:
        # initial_data = load_csv("../results/initial_parallel_nonblocking.csv")  # ← CHANGED
        # plot_heatmap(initial_data, "initial")
        
        # Plot final result
        final_data = load_csv("../results/final_nonblocking.csv")      # ← CHANGED
